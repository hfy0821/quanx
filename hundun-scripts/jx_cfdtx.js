...
*
  ...
  获取Token方式(三选一)：
   ...
   Quantumult X:
    [task_local]
    0 0 * * * jx_cfdtx.js, tag=财富岛兑换, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true
    [rewrite_local]
  ...
  Loon:
    ...
    cron "0 0 * * *" script-path=jx_cfdtx,tag=财富岛兑换
    
  Surge:
    财富岛兑换 = type=cron,cronexp="0 0 * * *",wake-system=1,timeout=20,script-path=jx_cfdtx
  ...
  Shadowrocket:
    [Script]
    财富岛兑换 = type=cron,script-path=jx_cfdtx,cronexpr="0 0 * * *",timeout=120,enable=true
...
function taskUrl(function_path, body) {
  return {
    ...
    headers: {
      ...
      Referer:"https://st.jingxi.com/fortune_island/index.html?ptag=138631.26.55&pps=",
      "Accept-Encoding": "gzip, deflate, br",
      Host: "m.jingxi.com",
      "User-Agent":"jdpingou;iPhone;4.2.2;12.4;d87719be5222fe93426ee1d84b0667f08194826b;network/4g;model/iPhone9,1;appBuild/100426;ADID/BC51D452-0302-49CD-928C-CCECAE9D4811;supportApplePay/1;hasUPPay/0;pushNoticeIsOpen/1;hasOCPay/0;supportBestPay/0;session/323;pap/JA2019_3111789;brand/apple;supportJDSHWK/1;",
