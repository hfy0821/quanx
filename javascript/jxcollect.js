...
#圈x
[rewrite local]
https://wq.jd.com/dreamfactory/generator/CollectCurrentElectricity? url script-request-header jxcollect.js
...
let realname = name.replace(/pwdt_id=/,'')
 return new Promise((resolve) => {
    let collect_url = {
   		url: `https://wq.jd.com/dreamfactory/generator/CollectCurrentElectricity?${jxcollecturl}`,
